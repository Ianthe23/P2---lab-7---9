...
class TestOperatiiStudenti(unittest.TestCase):
    ...
    def test_sterge_student(self):
        ...
        self.__repo.adauga_student(student)
        self.__repo.sterge_student(317)
    ...
    def test_modifica_student(self):
        ...
        self.__repo.adauga_student(student)
        self.__repo.modifica_student(317, "Alexe Andreea", 1)
    ...
    def test_cauta_ID(self):
        ...
        student = studenti(318, "Alexe Maria", 2)
        self.__repo.adauga_student(student)
        self.assertEqual(self.__repo.cauta_ID(318), student)
        self.assertEqual(self.__repo.cauta_ID(317).get_nume(), "Alexe Andrei")
